...
export function Home() {
  return (
   <Main>
         <div className='felx flex-col min-w-full  bg-[url(./desing/background_elements.png)] bg-no-repeat '>
            <div className='flex  w-full justify-center items-center '>
                ...
                <div className='min-w-[50%]'><img src="./desing/1.home/illustration1.png" alt="imagen ilustrativa de reunion de chicos" /></div>
            </div>
